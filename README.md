...
个人觉得配置Neovim非常有意思，但是如果是需要一个编辑器的话VS Code已经做的非常好了。个人维护一个功能十分完善的编辑器本身是有挑战的，
同时现在AI工具十分发达的情况下，代码编辑器的需求可能在降低。

但用Neovim从零配置一个独属于自己的编辑器真的很帅！

如果遇到问题可以问AI，其实配置Neovim并没有那么难！
